<template>
    <button class="button-start" @click="onClick">
        <span class="icon">

            <svg height="303.09363" width="187.41829" version="1.1">
                <path id="path4" stroke-linecap="round"
                    style="stroke:none;stroke-width:2.81;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:10;stroke-dasharray:none"
